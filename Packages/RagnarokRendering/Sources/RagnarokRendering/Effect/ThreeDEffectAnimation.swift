...
//  RagnarokRendering
//
//  Created by Leon Li on 2026/8/26.
//
...
public struct ThreeDEffectAnimation: Sendable {
    public struct Sample: Sendable {
        ...
        public var layers: [ThreeDEffectAnimation.Sample.Layer]
    }
    ...
    public func sample(
        ...
        let layers = frame.layers.map { layer -> ThreeDEffectAnimation.Sample.Layer in
            var layerSize = size * layer.sizeFactor
            if layer.isMirrored {
                layerSize.x = -layerSize.x
            }

            return ThreeDEffectAnimation.Sample.Layer(
        ...
        return ThreeDEffectAnimation.Sample(
