...
//            .init(path: "common/mmo.hpp", type: "e_job", prefix: "JOB_", excludes: ["JOB_MAX"], exportedType: "Job"),
            .init(path: "map/map.hpp", type: "_sp", prefix: "SP_", excludes: [], exportedType: "StatusProperty"),
            .init(path: "common/mmo.hpp", type: "e_sex", prefix: "SEX_", excludes: ["SEX_SERVER"], exportedType: "Sex"),
        ]
    ...
    private func generateEnum(context: PluginContext, configuration: Configuration) throws {
        ...
        public enum \(configuration.exportedType): Int, CaseIterable, Codable, Sendable {
        \(casesContents)
        }
        """
