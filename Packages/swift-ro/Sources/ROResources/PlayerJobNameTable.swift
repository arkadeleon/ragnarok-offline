...
public struct PlayerJobNameTable: Sendable {
    ...
    let imfNamesByJobID: [Int : String] = [
        0: "초보자",
        1: "검사",
        2: "마법사",
        3: "궁수",
    ...
    let palNamesByJobID: [Int : String] = [
        0: "초보자",
        1: "검사",
        2: "마법사",
        3: "궁수",
    ...
    let weaponNamesByJobID: [Int : String] = [
        0: "초보자\\초보자",
        1: "검사\\검사",
        2: "마법사\\마법사",
        3: "궁수\\궁수",
    ...
    public func imfName(for jobID: Int) -> String? {
        imfNamesByJobID[jobID]
    }

    public func palName(for jobID: Int) -> String? {
        palNamesByJobID[jobID]
    }

    public func weaponName(for jobID: Int) -> String? {
        weaponNamesByJobID[jobID]
    }
}
