public func add_packets(_ packet: (Int16, Int16) -> Void, _ parseable_packet: (Int16, Int16, String?, [Int]) -> Void, PACKETVER: Int, PACKETVER_MAIN_NUM: Int, PACKETVER_RE_NUM: Int, PACKETVER_ZERO_NUM: Int) {
    ...
    if PACKETVER >= 2009122 {
        ...
        packet(0x0804, 8)
        packet(0x0805, -1)
        parseable_packet(0x0806, 4, "clif_parse_PartyBookingDeleteReq", [2])
        packet(0x0808, 4)
    }
    if PACKETVER >= 20091229 {
        parseable_packet(0x0804, 14, "clif_parse_PartyBookingSearchReq", [2, 4, 6, 8, 12])
        parseable_packet(0x0806, 2, "clif_parse_PartyBookingDeleteReq", [0])
        packet(0x0807, 4)
        parseable_packet(0x0808, 14, "clif_parse_PartyBookingUpdateReq", [2])
        packet(0x0809, 50)
        packet(0x080A, 18)
        packet(0x080B, 6)
    }
    ...
    if PACKETVER >= 20120410 {
        ...
        packet(0x08ed, 43)
        packet(0x08ee, 6)
        parseable_packet(0x08ef, 6, nil, [2])
        packet(0x08f0, 6)
        parseable_packet(0x08f1, 6, nil, [2])
        packet(0x08f2, 36)
        packet(0x08f3, -1)
        packet(0x08f4, 6)
        parseable_packet(0x08f5, -1, nil, [2, 4])
        packet(0x08f6, 22)
        packet(0x08f7, 3)
        packet(0x08f8, 7)
        packet(0x08f9, 6)
    ...
    if PACKETVER >= 20120418 {
        ...
        parseable_packet(0x096A, 6, "clif_parse_GetCharNameRequest", [2])
        parseable_packet(0x0368, 6, "clif_parse_SolveCharName", [2])
        parseable_packet(0x08E5, 41, "clif_parse_PartyBookingRegisterReq", [2, 4, 6])
        packet(0x08d2, 10)
    }
    if PACKETVER >= 20120618 {
        packet(0x0983, 29)
        parseable_packet(0x0861, 41, "clif_parse_PartyBookingRegisterReq", [2, 4, 6])
    }
    ...
    if PACKETVER >= 20141008 {
        parseable_packet(0x9FB, -1, "clif_parse_pet_evolution", [2, 4])
        packet(0x09FC, 6)
    }
    if PACKETVER >= 20141016 {
        ...
        packet(0x09F7, 75)
        packet(0x09E6, 22)
        parseable_packet(0x0A19, 2, "clif_parse_roulette_open", [0])
        packet(0x0A1A, 23)
        parseable_packet(0x0A1B, 2, "clif_parse_roulette_info", [0])
        packet(0x0A1C, -1)
    ...
    if PACKETVER >= 20150513 {
        packet(0x09E7, 3)
        parseable_packet(0x09E8, 11, "clif_parse_Mail_refreshinbox", [2, 3])
        parseable_packet(0x09E9, 2, "clif_parse_dull", [0])
        parseable_packet(0x09EA, 11, "clif_parse_Mail_read", [2, 3])
        parseable_packet(0x09EC, -1, "clif_parse_Mail_send", [2, 4, 28, 52, 60, 62, 64])
        packet(0x09ED, 3)
        parseable_packet(0x09EE, 11, "clif_parse_Mail_refreshinbox", [2, 3])
        parseable_packet(0x09EF, 11, "clif_parse_Mail_refreshinbox", [2, 3])
        packet(0x09F0, -1)
        parseable_packet(0x09F1, 11, "clif_parse_Mail_getattach", [0])
        packet(0x09F2, 12)
        parseable_packet(0x09F3, 11, "clif_parse_Mail_getattach", [0])
        packet(0x09F4, 12)
        parseable_packet(0x09F5, 11, "clif_parse_Mail_delete", [0])
        packet(0x09F6, 11)
        parseable_packet(0x0A03, 2, "clif_parse_Mail_cancelwrite", [0])
        parseable_packet(0x0A04, 6, "clif_parse_Mail_setattach", [2, 4])
        parseable_packet(0x0A06, 6, "clif_parse_Mail_winopen", [2, 4])
        packet(0x0A07, 9)
        parseable_packet(0x0A08, 26, "clif_parse_Mail_beginwrite", [0])
        packet(0x0A12, 27)
        parseable_packet(0x0A13, 26, "clif_parse_Mail_Receiver_Check", [2])
        packet(0x0A14, 10)
        packet(0x0A32, 2)
        parseable_packet(0x0A35, 4, "clif_parse_Oneclick_Itemidentify", [2])
        packet(0x0A23, -1)
        packet(0x0A24, 66)
        parseable_packet(0x0A25, 6, "clif_parse_AchievementCheckReward", [0])
        packet(0x0A26, 7)
        parseable_packet(0x0A2E, 6, "clif_parse_change_title", [0])
        packet(0x0A2F, 7)
        packet(0x08FE, -1)
        packet(0x09F8, -1)
        packet(0x09F9, 143)
