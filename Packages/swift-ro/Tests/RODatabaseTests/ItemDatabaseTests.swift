...
final class ItemDatabaseTests: XCTestCase {
    ...
    func testPrerenewal() async throws {
        ...
        XCTAssertEqual(sword.subType, .weapon(._1hsword))
        ...
        XCTAssertEqual(turban.jobs, [.acolyte, .alchemist, .archer, .assassin, .bardDancer, .blacksmith, .crusader, .gunslinger, .hunter, .kagerouOboro, .knight, .mage, .merchant, .monk, .ninja, .priest, .rebellion, .rogue, .sage, .soulLinker, .starGladiator, .summoner, .swordman, .taekwon, .thief, .wizard])
