    ...
    private static let table: [Int : [EffectDefinition]] = [
        ...
        312: [ // EF_HEAL
            ...
            .`3D`(
                ...
                duration: 1.3,
                delayOffset: 0.4,
                duplicate: EffectDuplicate(count: 15, interval: 0.01),
                alphaMax: 0.6,
                fadesIn: true,
                fadesOut: true,
                blendMode: .one,
            ...
            .`3D`(
                ...
                duration: 1.1,
                delayLate: 0.2,
                duplicate: EffectDuplicate(count: 7, interval: 0.05),
                alphaMax: 0.6,
                fadesIn: true,
                fadesOut: true,
                blendMode: .one,
        ...
        320: [ // EF_HEAL3
            ...
            .`3D`(
                ...
                duration: 1,
                delayOffset: 0.4,
                duplicate: EffectDuplicate(count: 10, interval: 0.01),
                alphaMax: 0.8,
                fadesIn: true,
                fadesOut: true,
                blendMode: .one,
            ...
            .`3D`(
                ...
                duration: 0.9,
                delayLate: 0.2,
                duplicate: EffectDuplicate(count: 5, interval: 0.05),
                alphaMax: 0.8,
                fadesIn: true,
                fadesOut: true,
                blendMode: .one,
        ...
        321: [ // EF_WARPZONE2
            .cylinder(
                ...
                repeats: true,
                duration: 4,
                duplicate: EffectDuplicate(count: 4, interval: 1),
                topRadius: 3.3,
                bottomRadius: 2,
                height: 1.1,
                color: [0.5, 0.5, 1],
            ...
            .`3D`(
                ...
                repeats: true,
                duration: 1,
                duplicate: EffectDuplicate(count: 5, interval: 0.3),
                color: [0.9, 1, 0.9],
                alphaMax: 1,
                fadesIn: true,
                fadesOut: true,
