...
,  `magic_attack` integer  DEFAULT NULL
...
,  `job_kagerouoboro` integer  DEFAULT NULL
...
,  `job_rebellion` integer  DEFAULT NULL
...
,  `job_summoner` integer  DEFAULT NULL
...
,  `class_third` integer  DEFAULT NULL
,  `class_third_upper` integer  DEFAULT NULL
,  `class_third_baby` integer  DEFAULT NULL
